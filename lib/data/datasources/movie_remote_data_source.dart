...
import 'package:katalog_movie_app/data/models/movie_detail_model.dart';
import 'package:katalog_movie_app/data/models/movie_model.dart';
import 'package:katalog_movie_app/data/models/movie_response.dart';
...
class MovieRemoteDataSourceImpl implements MovieRemoteDataSource {
  ...
  Future<List<MovieModel>> getMovieSimilar(int id) async {
    final response =
        await client.get(Uri.parse('$BASE_URL/movie/$id/similar?$API_KEY'));
    if (response.statusCode == 200) {
      return MovieResponse.fromJson(jsonDecode(response.body)).movieList;
    } else {
      throw ServerException();
